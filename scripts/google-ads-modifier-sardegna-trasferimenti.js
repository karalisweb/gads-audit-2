...
function main() {
  ...
  Logger.log('ACCOUNT CONFIGURATO: SARDEGNA TRASFERIMENTI');
  ...
  if (currentCustomerId !== '1094402562') {
    Logger.log('ATTENZIONE: Questo script è configurato per SARDEGNA TRASFERIMENTI (1094402562)');
  ...
  try {
    ...
    Logger.log('\n=================================================');
    Logger.log('RIEPILOGO - SARDEGNA TRASFERIMENTI');
