...
function exportDataset(accountId, runId, datasetName, totalDatasets) {
  ...
  switch (datasetName) {
    ...
    case 'daily_ad_groups': data = extractDailyAdGroups(); break;
    case 'daily_keywords': data = extractDailyKeywords(); break;
    case 'daily_ads': data = extractDailyAds(); break;
    case 'daily_search_terms': data = extractDailySearchTerms(); break;
