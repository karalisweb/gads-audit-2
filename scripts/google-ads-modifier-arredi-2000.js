...
function main() {
  ...
  Logger.log('ACCOUNT CONFIGURATO: ARREDI 2000');
  ...
  if (currentCustomerId !== '5448290625') {
    Logger.log('ATTENZIONE: Questo script è configurato per ARREDI 2000 (5448290625)');
  ...
  try {
    ...
    Logger.log('\n=================================================');
    Logger.log('RIEPILOGO - ARREDI 2000');
