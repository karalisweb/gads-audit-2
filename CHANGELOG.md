...
### Aggiunto
- Stato salute conversioni - rileva le 'Inattive' (conversione primaria con 0 conversioni in 30gg = tracciamento rotto); badge rosso + card Inattive + colonna Conv.30gg, l'AI lo segnala come problema grave; script v3.6 importa metrics.all_conversions
...
### Aggiunto
- Contatore termini netti e negativizzati nella pagina Search Terms
...
### Aggiunto
- Integrate Gemini 3 Flash as alternative AI provider
...
### Corretto
- Parse adGroupId~criterionId in keyword modifications for all download scripts
